...
| RESP-01 | (§8.7, handout Part 9) | Responsive | Screenshot Login, Staff Queue, Staff Ticket Detail, and User Management at desktop/tablet/mobile widths | No horizontal overflow, clipping, or overlapping controls at any width | `e2e/lab-03/responsive-screenshots.spec.ts` | Pass |
